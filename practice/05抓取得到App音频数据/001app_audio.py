'''
 * @Author: HCQ 
 * @Date: 2018-06-20 23:04:26 
 * @Last Modified by:   HCQ 
 * @Last Modified time: 2018-06-20 23:04:26 
 */ Link:https://mp.weixin.qq.com/s?__biz=MjM5MTQ4NjA3Nw==&mid=2459678514&idx=1&sn=332e6cc98e86336c728ccbf8f362e2b6&chksm=b1dbce2086ac4736d5c16b1a9ac67d7ac159eb9750c2bc10db0057c18f8aba27803ac170340c&scene=21#wechat_redirect
'''
...
class dedao(object):
    ...
    def __init__(self):
        ...
        self.rows_title = [u'来源目录', u'标题', u'图片',
                           u'分享标题', u'mp3地址', u'音频时长', u'文件大小']
        sheet_name = u'逻辑思维音频'
    ...
    def parse_data(self, response):
        ...
        for data in datas:
            ...
            ExeclUtils.write_execl(
                self.execl_f, self.sheet_table, self.count, self.audio_info, u'逻辑思维音频.xlsx')
